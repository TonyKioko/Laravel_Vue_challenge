    ...
    handleSubmit: function handleSubmit(e) {
      ...
      if (this.password.length > 0) {
        ...
        axios.post("api/login", {
          ...
          localStorage.setItem("code_challenge.user", JSON.stringify(user));
          localStorage.setItem("code_challenge.jwt", response.data.token);
...
/* harmony import */ var _components_SingleProduct__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/SingleProduct */ "./resources/js/components/SingleProduct.vue");
...
vue__WEBPACK_IMPORTED_MODULE_0___default.a.use(vue_router__WEBPACK_IMPORTED_MODULE_1__["default"]); // import App from './App'
...
var router = new vue_router__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  routes: [{
    ...
    component: _components_SingleProduct__WEBPACK_IMPORTED_MODULE_5__["default"]
  } // {
  //     path: '/confirmation',
  //     name: 'confirmation',
...
router.beforeEach(function (to, from, next) {
  if (to.matched.some(function (record) {
    ...
    if (localStorage.getItem('code_challenge.jwt') == null) {
      ...
      var user = JSON.parse(localStorage.getItem('code_challenge.user'));
...
__webpack_require__(/*! /home/tonni/Desktop/code_challenge/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /home/tonni/Desktop/code_challenge/resources/sass/app.scss */"./resources/sass/app.scss");
